classdef UR3Batter < RobotBaseClass
    ...
    properties(Access = public)   
        plyFileNameStem = 'UR3Batter';
    end
    
    methods
%% Constructor
        function self = UR3Batter(baseTr,useTool,toolFilename)
            if nargin < 3
                if nargin == 2
...
%% CreateModel
        function CreateModel(self)
            ...
            link(6) = Link('d',0.0819+0.5,'a',0,'alpha',0,'qlim',deg2rad([-360,360]), 'offset', 0);
